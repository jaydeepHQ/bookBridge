...
import { Search, Trash2, ChevronLeft, ChevronRight, HelpCircle } from 'lucide-react';
...
export default function ManageQuiz() {
  ...
  useEffect(() => {
    const fetchQuizzes = async () => {
      try {
        ...
        const dataArr = allDataArr.filter(item => item.operation_type === 'quiz');
        ...
        toast.error("Failed to fetch quizzes from server");
      } finally {
        setLoading(false);
      }
    };
  ...
  const executeDelete = async () => {
    ...
    try {
      ...
      setQuizzes(quizzes.filter(q => q.id !== itemToDelete));
      ...
      <div className="p-8 min-h-screen bg-[#F8F9FC] font-['Inter']">
        <div>
          <PageHeader
            ...
            subtitle="View and manage all document quizzes in the system"
          />
        </div>
                  ...
                  <tr>
                    <td colSpan="6" className="px-8 py-12 text-center text-gray-500 font-medium">
                      <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <p className="text-lg text-gray-900 font-bold">Loading quizzes...</p>
                      </div>
                    </td>
                  </tr>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-sm rounded-[24px] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="p-6 text-center pt-8">
              ...
              <h2 className="text-xl font-black text-gray-900 mb-2">Delete Quiz?</h2>
