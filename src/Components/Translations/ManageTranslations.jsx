          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/50 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">
                <th className="px-6 py-4 text-center">Translation ID</th>
              ...
              {currentItems.length > 0 ? (
                currentItems.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50/30 transition-colors">
                    <td className="px-6 py-4 text-sm text-gray-700 text-center">{item.id}</td>
                    <td className="px-6 py-4 text-sm text-gray-700 text-center">{item.bookId}</td>
                    <td className="px-6 py-4 text-center">
                      <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-tight ${item.color}`}>
                        {item.language}
                      </span>
                    </td>
